			...
			<form method="post" action="/chalKag/freeBoardUpdate.do" enctype="multipart/form-data">
				<div class="row gtr-uniform">
					...
					<div class="col-12 col-12-xsmall">
						<input type="text" name="title" id="title" placeholder="Title" value="${boardData.title}"  required/>
					</div>
					<!-- 이미지 -->
					...
					<!-- 내용 -->
					<div class="col-12">
						<textarea name="contents" id="contents" placeholder="Enter your message" rows="6" >${boardData.contents}</textarea>
					</div>
					<!-- Break -->
					<div class="col-12">
						<ul class="actions">
