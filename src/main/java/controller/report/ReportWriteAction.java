...
public class ReportWriteAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
		...
		reportDTO.setMemberNum(Integer.parseInt(request.getParameter("suspectMemberNum")));
		reportDTO.setReporter((String)session.getAttribute("member"));
		reportDTO.setSuspect(request.getParameter("suspectMemberID")); // 카테고리 세팅 안하면 오류남! else문으로 가기위한 더미값 입력
