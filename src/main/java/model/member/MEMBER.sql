...
INSERT INTO MEMBER(MEMBERNUM,ID,PW,NAME,NICKNAME,BIRTH,PH,PROFILE,GRADE)
	VALUES((SELECT NVL(MAX(MEMBERNUM),0)+1 FROM MEMBER),'a@a.c','a','석진','진',(TO_DATE('19930910','YYYY-MM-DD')),'010-1234-5678','1.jpg','일반');
INSERT INTO MEMBER(MEMBERNUM,ID,PW,NAME,NICKNAME,BIRTH,PH,PROFILE,GRADE)
	VALUES((SELECT NVL(MAX(MEMBERNUM),0)+1 FROM MEMBER),'b@b8.c','b','티모','티모모',(TO_DATE('19930910','YYYY-MM-DD')),'010-1232-5678','일반');
INSERT INTO MEMBER(MEMBERNUM,ID,PW,NAME,NICKNAME,BIRTH,PH,PROFILE,GRADE)
