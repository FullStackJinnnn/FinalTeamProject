...
SELECT REPORTNUM, REPORTER FROM REP

ORT ORDER BY REPORTNUM DESC;


INSERT INTO REPORT(REPORTNUM, ID, SUSPECT, REPORTER, REPORTCONTENTS)
VALUES((SELECT NVL(MAX(REPORTNUM),0)+1 FROM REPORT),1,'a','b','c');