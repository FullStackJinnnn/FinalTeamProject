<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="model.board.*,java.util.ArrayList"%>
...
<head>
    ...
    <style>
        ...
        #priceDescButton.highlight {
            background-color: #F0F0F0; /* 원하는 배경색으로 변경해주세요 */
            color: blue; /* 원하는 글자 색으로 변경해주세요 */
            border: 1px solid blue; /* 원하는 테두리 색으로 변경해주세요 */
        }
...
<body class="is-preload">
    <%--  <% System.out.println("[로그] 데이터 확인 : "+request.getParameter("reviewBoardDatas")); %> --%>
    ...
    <div id="main">
        ...
        <div id="sortingButtons" style="margin-bottom: 10px;">
            <input type="button" value="Price ↑" id="priceAscButton"
                style="font-size: 16px; padding: 5px 10px;"> <input
                type="button" value="Price ↓" id="priceDescButton"
