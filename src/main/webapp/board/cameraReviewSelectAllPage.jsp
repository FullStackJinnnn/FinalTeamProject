...
<body class="is-preload">
	<%--  <% System.out.println("[로그 : cameraReviewSelectAllPage.jsp] 진입 : "+request.getParameter("reviewBoardDatas")); %> --%>
	<stone:printNav member='${member}' />

	<div id="main">
		<header class="major" style="padding-top: 110px;">
			<!-- 게시판 이름 -->
		...
		<div id="filterRemoteContainer">
			...
			<hr
				style="margin: 10px 0; background: #717981; height: 1px; border: 0;">
		</div>
		...
		<!-- 카메라 리뷰 게시판 데이터를 테이블로 표시하는 섹션 -->
		<div class="tableWrapper" style="margin-top: 20px;">
			<table class="alt" style="margin-top: 30px;">
				<thead>
					<tr>
						...
						<th width="12%" class="sortable" data-column="writer">writer</th>
						<th width="15%" class="sortable" data-column="boardDate">boardDate</th>
						<th width="16%" class="sortable" data-column="recommendCNT">recommendCNT</th>
