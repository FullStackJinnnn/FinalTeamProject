	...
	<div id="main">
		...
		<article class="post featured">
			<header class="major">
				...
				<p>
					Discover the world through lenses! 📷 Welcome to our Camera Review Board, <br>where shutterbugs unite to share insights on the latest cameras. 
					<br>Dive into detailed reviews, expert opinions, and community discussions.  
				</p>
			</header>
		</article>
