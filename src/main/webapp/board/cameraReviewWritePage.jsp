...
<body class="is-preload">
	...
	<div id="main">
		...
		<!-- Posts -->
		<form method="post" action="/chalKag/cameraReviewWrite.do" enctype="multipart/form-data">
			<div class="row gtr-uniform">
				...
				<!-- 내용 -->
				<div class="col-12">
					<textarea class="button primary" name="contents" id="contents" placeholder="Enter your post" rows="6" ></textarea>
				</div>
				<!-- Break -->
				<div class="col-12">
					<ul class="actions">
